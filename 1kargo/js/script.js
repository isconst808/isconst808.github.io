...
;
var menuBurger = document.querySelector('.header-menu__burger'),
    navMenu = document.querySelector('.header-menu__list'),
...
var firstSection = document.querySelector('[data-section="first"]');
arrowDown.addEventListener('click', function (e) {
  e.preventDefault();
  scrollToSibling(firstSection.nextElementSibling);
});
var commentsSliderImg = new Swiper('.comments__slider-img', {
  effect: 'flip',
  grabCursor: true,
  loop: true,
  navigation: {
    nextEl: '.comments__slider-btn_next',
    prevEl: '.comments__slider-btn_prev'
  }
});
var commentsSliderContent = new Swiper('.comments__slider-content', {
  loop: true,
  autoHeight: true
});
commentsSliderImg.controller.control = commentsSliderContent;
commentsSliderContent.controller.control = commentsSliderImg;
;
