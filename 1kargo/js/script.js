...
var swiper = new Swiper('.comments-slider', {
  navigation: {
    nextEl: '.comments-slider__btn_next',
    prevEl: '.comments-slider__btn_prev'
  },
  loop: true
});
var menuBurger = document.querySelector('.header-menu__burger'),
    mainMenu = document.querySelector('.header-menu__list');
menuBurger.addEventListener('click', function (e) {
  e.preventDefault();

  for (var i = 0; i < menuBurger.classList.length; i++) {
    if (menuBurger.classList[i] === 'active') {
