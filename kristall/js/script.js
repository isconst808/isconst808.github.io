...
document.addEventListener("DOMContentLoaded", function () {
  ...
  */
  !function (e, t) {
    ...
    var n = /*#__PURE__*/function (_Array) {
      ...
      function n(e) {
        ...
        _this2 = _super.call.apply(_super, [this].concat(_toConsumableArray(e || []))), function (e) {
          var t = e.__proto__;
  ...
  var mainBlock = "[data-spollers]",
      dataBtn = "data-spoller",
      dataOneSpoller = "data-one-spoller",
      classActive = "active",
      classInit = "init",
      slide = "slide";
  var spollersArray = document.querySelectorAll(mainBlock);
  ...
  if (spollersArray.length > 0) {
    ...
    var initSpollers = function initSpollers(spollersArray) {
      ...
      spollersArray.forEach(function (spollersBlock) {
        ...
        if (matchMedia.matches || !matchMedia) {
          spollersBlock.classList.add(classInit);
          initSpollerBody(spollersBlock);
          spollersBlock.addEventListener("click", setSpollerAction);
        } else {
          spollersBlock.classList.remove(classInit);
    ...
    var initSpollerBody = function initSpollerBody(spollersBlock) {
      ...
      var spollerTitles = spollersBlock.querySelectorAll("[".concat(dataBtn, "]"));
      ...
      if (spollerTitles.length > 0) {
        spollerTitles.forEach(function (spollerTitle) {
          if (hideSpollerBody) {
            ...
            if (!spollerTitle.classList.contains(classActive)) {
    ...
    var setSpollerAction = function setSpollerAction(e) {
      ...
      if (el.hasAttribute("".concat(dataBtn)) || el.closest("[".concat(dataBtn, "]"))) {
        var spollerTitle = el.hasAttribute("".concat(dataBtn)) ? el : el.closest("[".concat(dataBtn, "]"));
        var spollersBlock = spollerTitle.closest(mainBlock);
        var oneSpoller = spollersBlock.hasAttribute(dataOneSpoller) ? true : false; //Условие нужно ли добавлять акардеон

        if (!spollersBlock.querySelectorAll(".".concat(slide)).length) {
          if (oneSpoller && !spollerTitle.classList.contains(classActive)) {
            hideSpollersBody(spollersBlock);
          }

          spollerTitle.classList.toggle(classActive);
    ...
    var hideSpollersBody = function hideSpollersBody(spollersBlock) {
      var spollerActiveTitle = spollersBlock.querySelector("[".concat(dataBtn, "].").concat(classActive));

      if (spollerActiveTitle) {
        spollerActiveTitle.classList.remove(classActive);
  ...
  var menuBurger = document.querySelector("[data-menu-burger]"),
      btnClose = document.querySelector("[data-menu-close]"),
      navMenu = document.querySelector("[data-mobile-menu]"),
      navLink = document.querySelectorAll(".link-mobile-menu"),
      btnSpoller = document.querySelectorAll("[".concat(dataBtn, "]")),
      blocksSpoller = document.querySelectorAll(".spoller-mobile-menu__links"),
      tagBody = document.querySelector("body"),
      activeClass = "active";
  menuBurger.addEventListener("click", function (e) {
    navMenu.classList.add(activeClass);
    tagBody.classList.add("lock");
  });
  ...
  function closeNavMenu() {
    blocksSpoller.forEach(function (elem) {
      if (elem.style.display !== "none") {
        elem.style.display = "none";
      }
    });
    btnSpoller.forEach(function (elem) {
  ...
  ;
  var swiperOurWork = new Swiper(".our-work__swiper", {
    slidesPerView: 1,
    spaceBetween: 12,
    loop: true,
    navigation: {
      nextEl: ".our-work__swiper-btn-next",
      prevEl: ".our-work__swiper-btn-prev"
    },
    pagination: {
      el: ".our-work__swiper-pagination",
      dynamicBullets: true
    },
    breakpoints: {
      511: {
